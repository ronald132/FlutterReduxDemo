...
ThunkAction<AppState> getRandomQuote = (Store<AppState> store) async {
  http.Response response = await http.get(Uri.parse("http://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=1"));
  ...
  String quote = result["message"];
  String author = result["code"];
